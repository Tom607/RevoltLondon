...
}, 250); //balancetext http://www.pagetoscreen.net/journal/item/balancing_long_lines_in_headings
...
!function (a) {
  ...
  var e = function e(a) {
    ...
    return 0 === b || b === a.length || e(a.charAt(b - 1)) && !e(a.charAt(b));
      ...
      j = function j(a, b, c, d, e, f, g) {
    for (var h;;) {
      for (; !i(b, f);) {
        f += e;
      }

      if (a.text(b.substr(0, f)), h = a.width(), 0 > e ? d >= h || 0 >= h || 0 === f : h >= d || h >= c || f === b.length) break;
      f += e;
    }
  ...
  a.fn.balanceText = function () {
    return c ? this : this.each(function () {
      ...
      f(b);
      var e = "";
      b.attr("style") && b.attr("style").indexOf("line-height") >= 0 && (e = b.css("line-height")), b.css("line-height", "normal");
      var i = b.width(),
          k = b.height(),
          l = b.css("white-space"),
          m = b.css("float"),
      ...
      if (i > 0 && p > i && c > p) {
        for (var s = b.text(), t = "", u = "", v = g(b), w = Math.round(k / q), x = w; x > 1;) {
          ...
          var C;
          C = 0 === A.index ? B.index : i < B.width || A.index === B.index ? A.index : Math.abs(y - A.width) < Math.abs(B.width - y) ? A.index : B.index, u = s.substr(0, C), v ? t += h(b, u, i) : (t += u.trimRight(), t += '<br data-owner="balance-text" />'), s = s.substr(C), x--, b.text(s), p = b.width();
        }
  ...
  }, a(window).ready(k), a(window).resize(k);
}(jQuery);