new gridjs.Grid({
  ...
  data: [
    ...
    ["Climate change", "Environment", 2, "SAME", 3587, 19, 1, 4, 18],
    ["Access to healthcare", "Political", 3, "UP", 3409, 2, 3, 6, 2],
    ["Famine and food security", "Environment", 4, "SAME", 3283, 6, 13, 2, 5],
    ...
    ["Pollution of my local environment", "Environment", 14, "DOWN", 2791, 25, 23, 3, 17],
    ["Care for the elderly", "Social", 15, "UP", 2757, 11, 10, 19, 16],
    ["The health of our oceans", "Environment", 16, "DOWN", 2719, 22, 8, 14, 19],
    ["Fair wages", "Economic", 17, "DOWN", 2611, 18, 20, 23, 14],
    ["Recycling and waste", "Environment", 18, "SAME", 2588, 27, 12, 20, 15],
    ["Cyber and data security", "Technology", 19, "DOWN", 2573, 17, 28, 12, 30],
    ["Natural disaster prevention and relief", "Environment", 20, "DOWN", 2567, 23, 30, 10, 22],
    ...
    ["Deforestation", "Environment", 23, "SAME", 2503, 36, 19, 21, 11],
    ...
    ["Biodiversity and species extinction", "Environment", 28, "SAME", 2342, 39, 26, 15, 23],
    ...
    ["The plastic crisis", "Environment", 34, "DOWN", 2173, 44, 18, 22, 35],
    ...
    ["Animal rights", "Environment", 40, "SAME", 1954, 40, 25, 47, 32],
